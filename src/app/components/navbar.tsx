...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-red-900 via-purple-500 to-blue-700 p-4 shadow-md">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex space-x-4">
          <Link
            href="/"
            className="mr-2 flex items-center px-4 py-2 rounded-md text-white hover:bg-opacity-20 hover:bg-black transition">
            <FaHome /> Home
          </Link>
          <Link
            href="/clientside"
      ...
      >
        <div className="flex flex-col items-end pt-6">
          ...
          <Link
            href="/"
            className="mr-2 flex items-center w-full px-4 py-3 rounded-md text-center text-white hover:bg-opacity-20 hover:bg-black transition"
            onClick={close}
          >
            <FaHome /> Home
          </Link>
